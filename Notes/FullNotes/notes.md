# 🐘 PHP Mastery Notes — Complete Guide for Interviews, Projects & Placements

> **Author's Note:** These notes cover PHP from absolute scratch to advanced level. Every concept is explained simply with real examples. Perfect for GitHub storage, quick revision, interviews, and placement preparation.
...
11. [Superglobals](#11-superglobals)
12. [Forms & User Input](#12-forms--user-input)
13. [File Handling](#13-file-handling)
14. [Object-Oriented PHP (OOP)](#14-object-oriented-php-oop)
15. [Error Handling & Exceptions](#15-error-handling--exceptions)
16. [PHP & MySQL (Database)](#16-php--mysql-database)
17. [Sessions & Cookies](#17-sessions--cookies)
18. [PHP Security](#18-php-security)
19. [PHP Built-in Functions Cheatsheet](#19-php-built-in-functions-cheatsheet)
